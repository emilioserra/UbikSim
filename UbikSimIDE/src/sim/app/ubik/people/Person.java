...
abstract public class Person extends Observable implements Steppable, Stoppable, Oriented2D {
    ...
    public boolean setPosition(int x, int y) {
        ...
        setChanged();
        notifyObservers(this);
        if(subjectiveView) changeCameraView();
        return true;
    }
 ...
 */
    ...
    /**
     * Clase para representar qué properción (percent) del peso total se distribuye 
     * en un punto (position) de la persona.
     * 
     */
    ...
    /**
     * Cambia el color del objeto que representa la persona.
     * Para que tenga su aspecto original, pasar null como parámetro.
     * 
     * @param c Color de la persona
     */
    public void setColor(Color c) {
        if(c==null) this.getPerson3DModel().setColor(null);
        else this.person3DModel.setColor(c.getRGB());
    }
