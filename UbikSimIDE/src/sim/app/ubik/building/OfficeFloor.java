...
public class OfficeFloor {
    ...
    public OfficeFloor(Home home, int floor, Ubik simulation) {
    	System.out.println("OfficeFloor("+floor+")");
        this.home = home;
        ...
        System.out.println("Creando planta "+floor+" con dimensiones: "+GRID_WIDTH + ", " + GRID_HEIGHT);
    ...
    public void clear() throws InterruptedException {
    	System.out.println("OfficeFloor.clear()");
