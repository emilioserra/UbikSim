 ...
 * specified in the <code>ubik3d.j3d.additionalLoaderClasses</code>
...
public class ModelManager {
  ...
  private static final String ADDITIONAL_LOADER_CLASSES = "ubik3d.j3d.additionalLoaderClasses";
    ...
    if (modelRoot != null) {
      ...
      try {
        ...
        synchronized (this.loadedModelNodes) {
          ...
          this.loadedModelNodes.put(content, modelRoot);
        }
        modelObserver.modelUpdated((BranchGroup)cloneNode(modelRoot));
  ...
  public Area getAreaOnFloor(Node node) {
    ...
    if (vertexCount < 10000) {
      ...
      GeneralPath generalPath = new GeneralPath(Path2D.WIND_NON_ZERO, surroundingPolygon.length);
