...
public class Component3DManager {
  private static final String CHECK_OFF_SCREEN_IMAGE_SUPPORT = "ubik3d.j3d.checkOffScreenSupport";
   ...
   * Will always return <code>false</code> if <code>ubik3d.j3d.checkOffScreenSupport</code>
   * system is equal to <code>false</code>. By default, <code>ubik3d.j3d.checkOffScreenSupport</code>
  ...
  public Canvas3D getOffScreenCanvas3D(int width, int height) {
    ...
    ImageComponent2D imageComponent2D = new ImageComponent2D(ImageComponent.FORMAT_RGB, image);
