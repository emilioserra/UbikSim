...
public class RoomPanel extends JPanel implements DialogView {
  ...
  private void createComponents(UserPreferences preferences, final RoomController controller) {
    ...
    this.nameLabel = new JLabel(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class, "nameLabel.text"));
    this.nameTextField = new JTextField(controller.getName(), 10);
    if (!OperatingSystem.isMacOSXLeopardOrSuperior()) {
      SwingTools.addAutoSelectionOnFocusGain(this.nameTextField);
    }
    this.roomTypes = new JComboBox(controller.getRoomTypes());
    this.roomTypes.setEditable(true);
    this.roomTypes.setSelectedItem(controller.getType());
    final PropertyChangeListener typeChangeListener = new PropertyChangeListener() {
      public void propertyChange(PropertyChangeEvent ev) {
        int index = controller.getRoomTypes().indexOf(controller.getType());
        roomTypes.setSelectedItem(index);
        System.out.println("propertyChange: "+roomTypes.getItemAt(index));
        System.out.println("index = "+index);
      }
    };
    controller.addPropertyChangeListener(RoomController.Property.TYPE, typeChangeListener);
    this.roomTypes.addItemListener(new ItemListener() {
      public void itemStateChanged(ItemEvent e) {
        String type = (String) e.getItem();
        System.out.println("itemStateChanged: "+type);
        controller.removePropertyChangeListener(RoomController.Property.TYPE, typeChangeListener);
    ...
    this.areaVisibleCheckBox = new NullableCheckBox(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
        "areaVisibleCheckBox.text"));
    ...
    this.floorVisibleCheckBox = new NullableCheckBox(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
        "floorVisibleCheckBox.text"));
    ...
    this.floorColorRadioButton = new JRadioButton(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
        "floorColorRadioButton.text"));
    ...
    this.floorTextureRadioButton = new JRadioButton(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
    ...
    // Floor shininess radio buttons bound to FLOOR_SHININESS controller
    // property
    this.floorMattRadioButton = new JRadioButton(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
        "floorMattRadioButton.text"));
    ...
    this.floorShinyRadioButton = new JRadioButton(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
        "floorShinyRadioButton.text"));
    ...
    // Create ceiling visible check box bound to CEILING_VISIBLE controller
    // property
    this.ceilingVisibleCheckBox = new NullableCheckBox(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
        "ceilingVisibleCheckBox.text"));
    ...
    this.ceilingColorRadioButton = new JRadioButton(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
        "ceilingColorRadioButton.text"));
    ...
    this.ceilingColorButton.setColorDialogTitle(preferences.getLocalizedString(RoomPanel.class,
        "ceilingColorDialog.title"));
    ...
    this.ceilingTextureRadioButton = new JRadioButton(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
        "ceilingTextureRadioButton.text"));
    ...
    // Ceiling shininess radio buttons bound to CEILING_SHININESS controller
    // property
    this.ceilingMattRadioButton = new JRadioButton(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
        "ceilingMattRadioButton.text"));
    ...
    this.ceilingShinyRadioButton = new JRadioButton(SwingTools.getLocalizedLabelText(preferences, RoomPanel.class,
        "ceilingShinyRadioButton.text"));
   ...
   */
  private void layoutComponents(UserPreferences preferences, final RoomController controller) {
    int labelAlignment = OperatingSystem.isMacOSX()
        ? GridBagConstraints.LINE_END
        : GridBagConstraints.LINE_START;
    // First row
    Insets rowInsets;
    JPanel nameAndAreaPanel = SwingTools.createTitledPanel(preferences.getLocalizedString(RoomPanel.class,
        "nameAndAreaPanel.title"));
    ...
    nameAndAreaPanel.add(this.nameTextField, new GridBagConstraints(1, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START,
    ...
    add(nameAndAreaPanel, new GridBagConstraints(0, 0, 2, 1, 0, 0, GridBagConstraints.LINE_START,
        GridBagConstraints.HORIZONTAL, rowInsets, 0, 0));
    JPanel semanticPanel = SwingTools.createTitledPanel("Semantics Properties");
    semanticPanel.add(this.roomTypes, new GridBagConstraints(
            0, 0, 1, 1, 0, 0, labelAlignment,
            GridBagConstraints.HORIZONTAL, new Insets(0, 8, 0, 5), 0, 0));
    add(semanticPanel, new GridBagConstraints(
            0, 1, 2, 1, 1, 0, GridBagConstraints.LINE_START,
            GridBagConstraints.HORIZONTAL, rowInsets, 0, 0));
    // Last row
    JPanel floorPanel = createVerticalTitledPanel(preferences.getLocalizedString(RoomPanel.class, "floorPanel.title"),
        new JComponent [] {this.floorVisibleCheckBox, null, this.floorColorRadioButton, this.floorColorButton,
            this.floorTextureRadioButton, this.floorTextureComponent});
    floorPanel.add(new JSeparator(), new GridBagConstraints(0, 3, 2, 1, 1, 0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(3, 0, 3, 0), 0, 0));
    floorPanel.add(this.floorMattRadioButton, new GridBagConstraints(0, 4, 1, 1, 1, 0, GridBagConstraints.LINE_START,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 5), 0, 0));
    floorPanel.add(this.floorShinyRadioButton, new GridBagConstraints(1, 4, 1, 1, 1, 0, GridBagConstraints.LINE_START,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    add(floorPanel, new GridBagConstraints(0, 2, 1, 1, 1, 0, GridBagConstraints.LINE_START,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

    JPanel ceilingPanel = createVerticalTitledPanel(
        preferences.getLocalizedString(RoomPanel.class, "ceilingPanel.title"), new JComponent [] {
    ...
    ceilingPanel.add(new JSeparator(), new GridBagConstraints(0, 3, 2, 1, 1, 0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(3, 0, 3, 0), 0, 0));
    ceilingPanel.add(this.ceilingMattRadioButton, new GridBagConstraints(0, 4, 1, 1, 1, 0,
        GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(0, 0, 0, 5), 0, 0));
    ceilingPanel.add(this.ceilingShinyRadioButton, new GridBagConstraints(1, 4, 1, 1, 1, 0,
        GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    add(ceilingPanel, new GridBagConstraints(1, 2, 1, 1, 1, 0, GridBagConstraints.LINE_START,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
  }
  ...
  private JPanel createVerticalTitledPanel(String title, JComponent [] components) {
    ...
    for (int i = 0; i < components.length; i += 2) {
      int bottomInset = i < components.length - 2
          ? 2
          : 0;
      JComponent component = components [i];
      JComponent nextComponent = components [i + 1];
      if (nextComponent != null) {
        titledPanel.add(component, new GridBagConstraints(0, i / 2, 1, 1, 1, 0, GridBagConstraints.LINE_START,
            GridBagConstraints.NONE, new Insets(0, 0, bottomInset, 5), 0, 0));
        titledPanel.add(nextComponent, new GridBagConstraints(1, i / 2, 1, 1, 1, 0, GridBagConstraints.LINE_START,
            GridBagConstraints.HORIZONTAL, new Insets(0, 0, bottomInset, 0), 0, 0));
      } else {
        titledPanel.add(component, new GridBagConstraints(0, i / 2, 2, 1, 1, 0, GridBagConstraints.LINE_START,
            GridBagConstraints.HORIZONTAL, new Insets(0, 0, bottomInset, 0), 0, 0));
      }
    }
    return titledPanel;
