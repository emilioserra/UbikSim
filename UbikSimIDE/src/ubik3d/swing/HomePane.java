...
public class HomePane extends JRootPane implements HomeView {
  ...
  private static final String MAIN_PANE_DIVIDER_LOCATION_VISUAL_PROPERTY     = "ubik3d.SweetHome3D.MainPaneDividerLocation";
  private static final String CATALOG_PANE_DIVIDER_LOCATION_VISUAL_PROPERTY  = "ubik3d.SweetHome3D.CatalogPaneDividerLocation";
  private static final String PLAN_PANE_DIVIDER_LOCATION_VISUAL_PROPERTY     = "ubik3d.SweetHome3D.PlanPaneDividerLocation";
  private static final String PLAN_VIEWPORT_X_VISUAL_PROPERTY                = "ubik3d.SweetHome3D.PlanViewportX";
  private static final String PLAN_VIEWPORT_Y_VISUAL_PROPERTY                = "ubik3d.SweetHome3D.PlanViewportY";
  private static final String FURNITURE_VIEWPORT_Y_VISUAL_PROPERTY           = "ubik3d.SweetHome3D.FurnitureViewportY";
  ...
  private KeyListener specialKeysListener = new KeyAdapter() {
      ...
      public void keyPressed(KeyEvent ev) {
        ...
        if (ev.getKeyCode() == KeyEvent.VK_SPACE 
            && (ev.getModifiers() & (InputEvent.ALT_MASK | InputEvent.CTRL_MASK | InputEvent.META_MASK)) == 0
      ...
      public void keyTyped(KeyEvent ev) {
        ...
        int modifiersMask = InputEvent.ALT_MASK | InputEvent.CTRL_MASK | InputEvent.META_MASK;
    ...
    if (planView != null) {
      ...
      if (planView instanceof Scrollable) {
        ...
        if (lockUnlockBasePlanButton != null) {
          planScrollPane.setCorner(ScrollPaneConstants.UPPER_LEADING_CORNER, lockUnlockBasePlanButton);
  ...
  private void detachView(final View view, int x, int y, int width, int height) {
    ...
    separateDialog.setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);
   ...
   * @return {@link ubik3d.viewcontroller.HomeView.SaveAnswer#SAVE} 
   * if the user chose to save home,
   * {@link ubik3d.viewcontroller.HomeView.SaveAnswer#DO_NOT_SAVE} 
   * if he doesn't want to save home,
   * or {@link ubik3d.viewcontroller.HomeView.SaveAnswer#CANCEL} 
