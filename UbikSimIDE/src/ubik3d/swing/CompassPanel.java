  ...
  private void createComponents(UserPreferences preferences, 
    ...
    final SpinnerNumberModel northDirectionSpinnerModel = new SpinnerNumberModel(0, 0, 360, 5) {
        ...
        public Object getNextValue() {
          if (((Number)getValue()).intValue() + getStepSize().intValue() < ((Number)getMaximum()).intValue()) {
            return super.getNextValue();
          } else {
            return ((Number)getValue()).intValue() + getStepSize().intValue() - ((Number)getMaximum()).intValue() + ((Number)getMinimum()).intValue();
          }
        }
        ...
        public Object getPreviousValue() {
          if (((Number)getValue()).intValue() - getStepSize().intValue() >= ((Number)getMinimum()).intValue()) {
            ...
            return ((Number)getValue()).intValue() - getStepSize().intValue() - ((Number)getMinimum()).intValue() + ((Number)getMaximum()).intValue();
          }
        }
      };
