...
public class ImportedFurnitureWizardStepsPanel extends JPanel implements ImportedFurnitureWizardStepsView {
  ...
  private void createComponents(final boolean importHomePiece, final UserPreferences preferences,
      ...
      public void actionPerformed(ActionEvent ev) {
        ...
        if (service != null) {
          try {
            ...
            final URL findModelsUrl = new URL(preferences.getLocalizedString(ImportedFurnitureWizardStepsPanel.class,
    ...
    this.turnLeftButton = new JButton(new ResourceAction(preferences, ImportedFurnitureWizardStepsPanel.class,
        "TURN_LEFT", true) {
      @Override
      public void actionPerformed(ActionEvent ev) {
    ...
    this.turnRightButton = new JButton(new ResourceAction(preferences, ImportedFurnitureWizardStepsPanel.class,
        "TURN_RIGHT", true) {
      @Override
      public void actionPerformed(ActionEvent ev) {
        Transform3D oldTransform = getModelRotationTransform();
    ...
    this.turnUpButton = new JButton(new ResourceAction(preferences, ImportedFurnitureWizardStepsPanel.class, "TURN_UP",
        true) {
      @Override
      public void actionPerformed(ActionEvent ev) {
        Transform3D oldTransform = getModelRotationTransform();
    ...
    this.turnDownButton = new JButton(new ResourceAction(preferences, ImportedFurnitureWizardStepsPanel.class,
        "TURN_DOWN", true) {
      @Override
      public void actionPerformed(ActionEvent ev) {
        Transform3D oldTransform = getModelRotationTransform();
    ...
    this.rolLabel = new JLabel("Rol:");
    this.rolTextField = new JTextField(10);
    if (!OperatingSystem.isMacOSXLeopardOrSuperior()) {
      SwingTools.addAutoSelectionOnFocusGain(this.rolTextField);
    }

    DocumentListener rolListener = new DocumentListener() {
      public void changedUpdate(DocumentEvent ev) {
        rolTextField.getDocument().removeDocumentListener(this);
        controller.setRol(rolTextField.getText().trim());
        rolTextField.getDocument().addDocumentListener(this);
      }
    ...
    final Color defaultRolTextFieldColor = this.rolTextField.getForeground();
    this.rolTextField.getDocument().addDocumentListener(rolListener);
    controller.addPropertyChangeListener(ImportedFurnitureWizardController.Property.ROL, new PropertyChangeListener() {
      public void propertyChange(PropertyChangeEvent ev) {
        // If name changes update name text field
        if (!rolTextField.getText().trim().equals(controller.getRol())) {
          rolTextField.setText(controller.getRol());
        }
        updateRolTextFieldForeground(defaultRolTextFieldColor);
      }
    });
    ...
    final NullableSpinner.NullableSpinnerLengthModel widthSpinnerModel = new NullableSpinner.NullableSpinnerLengthModel(
        preferences, Math.min(controller.getWidth(), minimumLength), 100000f);
    ...
    final NullableSpinner.NullableSpinnerLengthModel depthSpinnerModel = new NullableSpinner.NullableSpinnerLengthModel(
        preferences, Math.min(controller.getDepth(), minimumLength), 100000f);
    ...
    final NullableSpinner.NullableSpinnerLengthModel heightSpinnerModel = new NullableSpinner.NullableSpinnerLengthModel(
        preferences, Math.min(controller.getHeight(), minimumLength), 100000f);
  ...
  private void layoutComponents() {
    ...
    attributesPanel.add(this.rolLabel, new GridBagConstraints(1, 1, 1, 1, 0, 0, GridBagConstraints.LINE_START,
        GridBagConstraints.NONE, new Insets(0, 0, 10, 5), 0, 0));
    attributesPanel.add(this.rolTextField, new GridBagConstraints(2, 1, 1, 1, 0, 0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 10, 0), 0, 0));
    attributesPanel.add(this.nameLabel, new GridBagConstraints(1, 2, 1, 1, 0, 0, GridBagConstraints.LINE_START,
        GridBagConstraints.NONE, new Insets(0, 0, 10, 5), 0, 0));
    attributesPanel.add(this.nameTextField, new GridBagConstraints(2, 2, 1, 1, 0, 0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 10, 0), 0, 0));
    attributesPanel.add(this.addToCatalogCheckBox, new GridBagConstraints(1, 3, 2, 1, 0, 0,
        GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(0, 0, 10, 0), 0, 0));
    attributesPanel.add(this.categoryLabel, new GridBagConstraints(1, 4, 1, 1, 0, 0, GridBagConstraints.LINE_START,
        GridBagConstraints.NONE, new Insets(0, 0, 10, 5), 0, 0));
    attributesPanel.add(this.categoryComboBox, new GridBagConstraints(2, 4, 1, 1, 0, 0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 10, 0), 0, 0));
    ...
    attributesPanel.add(this.keepProportionsCheckBox, new GridBagConstraints(1, 8, 2, 1, 0, 0,
        GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(0, 0, 15, 0), 0, 0));
  ...
  public void updateStep(ImportedFurnitureWizardController controller) {
    ...
    switch (step) {
      case MODEL:
        ...
        break;
      case ATTRIBUTES:
        this.rolTextField.requestFocusInWindow();
        break;
    }
  }

  /**
   * Updates rol text field foreground color depending on the validity of the
   * piece name.
   */
  private void updateRolTextFieldForeground(Color defaultRolTextFieldColor) {
    rolTextField.setForeground(this.controller.isPieceOfFurnitureNameValid()
        ? defaultRolTextFieldColor
        : Color.RED);
  }

  /**
   * Updates name text field foreground color depending on the validity of the
   * piece name.
   */
   ...
   */
  private void showModelChoiceError(final String modelName, final UserPreferences preferences) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        JOptionPane.showMessageDialog(SwingUtilities.getRootPane(ImportedFurnitureWizardStepsPanel.this),
   ...
   * format. Caution : this method must be thread safe because it's called from
   * model loader executor.
   */
  ...
  /**
   * Reads 3D model from <code>modelContent</code>. Caution : this method must
   * be thread safe because it's called from model loader executor.
   */
  ...
  private static abstract class AbstractModelPreviewComponent extends ModelPreviewComponent {
     ...
     * piece model displayed by this component.
     */
      ...
      PropertyChangeListener rotationChangeListener = new PropertyChangeListener() {
        public void propertyChange(PropertyChangeEvent ev) {
          ...
          if (ev.getOldValue() != null) {
            ...
            float oldWidth = oldModelRotationMatrix.m00 * width + oldModelRotationMatrix.m01 * height
                             + oldModelRotationMatrix.m02 * depth;
            float oldHeight = oldModelRotationMatrix.m10 * width + oldModelRotationMatrix.m11 * height
                              + oldModelRotationMatrix.m12 * depth;
            float oldDepth = oldModelRotationMatrix.m20 * width + oldModelRotationMatrix.m21 * height
                             + oldModelRotationMatrix.m22 * depth;

            // Compute size after new model rotation
            float [][] newModelRotation = (float [][]) ev.getNewValue();
            controller.setWidth(Math.abs(newModelRotation [0] [0] * oldWidth + newModelRotation [0] [1] * oldHeight
                                         + newModelRotation [0] [2] * oldDepth));
            controller.setHeight(Math.abs(newModelRotation [1] [0] * oldWidth + newModelRotation [1] [1] * oldHeight
                                          + newModelRotation [1] [2] * oldDepth));
            controller.setDepth(Math.abs(newModelRotation [2] [0] * oldWidth + newModelRotation [2] [1] * oldHeight
  ...
  private static class RotationPreviewComponent extends AbstractModelPreviewComponent {
    ...
    private void createComponents(UserPreferences preferences) {
      ...
      setBorder(null);
      // Add a hierarchy listener to link canvases to universe once this
    ...
    /**
     * Adds a hierarchy listener to this component to manage canvases attachment
     * to universe.
     */
    private void addHierarchyListener() {
      addAncestorListener(new AncestorListener() {
        public void ancestorAdded(AncestorEvent event) {
          // Attach the 3 other canvases to super class universe with their own
          // view
          createView(0, 0, 1, View.PARALLEL_PROJECTION).addCanvas3D(frontViewCanvas);
          createView(Locale.getDefault().equals(Locale.US)
              ? -(float) Math.PI / 2
              : (float) Math.PI / 2, 0, 1, View.PARALLEL_PROJECTION).addCanvas3D(sideViewCanvas);
    ...
    private void layoutComponents() {
      ...
      if (Locale.getDefault().equals(Locale.US)) {
        ...
        add(getCanvas3DBorderedPanel(defaultCanvas), new GridBagConstraints(0, 1, 1, 1, 1, 1,
        ...
        add(getCanvas3DBorderedPanel(this.topViewCanvas), new GridBagConstraints(1, 1, 1, 1, 1, 1,
        ...
        add(this.sideViewLabel, new GridBagConstraints(0, 2, 1, 1, 0, 0, GridBagConstraints.CENTER,
            GridBagConstraints.NONE, new Insets(0, 0, 2, 5), 0, 0));
        add(getCanvas3DBorderedPanel(this.sideViewCanvas), new GridBagConstraints(0, 3, 1, 1, 1, 1,
        ...
        add(this.frontViewLabel, new GridBagConstraints(1, 2, 1, 1, 0, 0, GridBagConstraints.CENTER,
            GridBagConstraints.NONE, new Insets(0, 0, 2, 0), 0, 0));
        add(getCanvas3DBorderedPanel(this.frontViewCanvas), new GridBagConstraints(1, 3, 1, 1, 1, 1,
            GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
      } else {
        // Right view at top left
        add(this.sideViewLabel, new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.CENTER,
            GridBagConstraints.NONE, new Insets(0, 0, 2, 5), 0, 0));
        add(getCanvas3DBorderedPanel(this.sideViewCanvas), new GridBagConstraints(0, 1, 1, 1, 1, 1,
            GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
        // Front view at top right
        add(this.frontViewLabel, new GridBagConstraints(1, 0, 1, 1, 0, 0, GridBagConstraints.CENTER,
            GridBagConstraints.NONE, new Insets(0, 0, 2, 0), 0, 0));
        add(getCanvas3DBorderedPanel(this.frontViewCanvas), new GridBagConstraints(1, 1, 1, 1, 1, 1,
            GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
        ...
        add(this.perspectiveViewLabel, new GridBagConstraints(0, 2, 1, 1, 0, 0, GridBagConstraints.CENTER,
            GridBagConstraints.NONE, new Insets(0, 0, 2, 5), 0, 0));
        add(getCanvas3DBorderedPanel(defaultCanvas), new GridBagConstraints(0, 3, 1, 1, 1, 1,
            GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
        // Top view at bottom right
        add(this.topViewLabel, new GridBagConstraints(1, 2, 1, 1, 0, 0, GridBagConstraints.CENTER,
            GridBagConstraints.NONE, new Insets(0, 0, 2, 0), 0, 0));
        add(getCanvas3DBorderedPanel(this.topViewCanvas), new GridBagConstraints(1, 3, 1, 1, 1, 1,
            GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
      }
    }
  }
