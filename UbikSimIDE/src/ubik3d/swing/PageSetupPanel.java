...
import ubik3d.swing.NullableSpinner.NullableSpinnerNumberModel;
...
public class PageSetupPanel extends JPanel implements DialogView {
  ...
  private void updateComponents(HomePrint homePrint) {
    ...
    this.view3DPrintedCheckBox.setVisible(!"true".equalsIgnoreCase(System.getProperty("ubik3d.no3D")));
  }
