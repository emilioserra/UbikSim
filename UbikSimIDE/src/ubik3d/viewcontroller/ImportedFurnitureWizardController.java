...
public class ImportedFurnitureWizardController extends WizardController implements Controller {
  public enum Property {
    STEP, METADATA, ROL, NAME, MODEL, AMOUNT, WIDTH, DEPTH, HEIGHT, ELEVATION, MOVABLE, DOOR_OR_WINDOW, COLOR, CATEGORY, BACK_FACE_SHOWN, MODEL_ROTATION, ICON_YAW, PROPORTIONAL
  }
  ...
  /**
   * Creates a controller that edits a new catalog piece of furniture with a
   * given <code>modelName</code>.
   */
   ...
   */
  public ImportedFurnitureWizardController(Home home, UserPreferences preferences, ViewFactory viewFactory,
  ...
  /**
   * Creates a controller that edits a new imported home piece of furniture with
   * a given <code>modelName</code>.
   */
  ...
  private ImportedFurnitureWizardController(Home home, CatalogPieceOfFurniture piece, String modelName,
    ...
    setTitle(this.preferences.getLocalizedString(ImportedFurnitureWizardController.class, piece == null
  ...
  public void finish() {
    ...
    if (isDoorOrWindow()) {
      newPiece = new CatalogDoorOrWindow(getMetadata(), getRol(), getName(), getIcon(), getModel(), getAmount(), getWidth(), getDepth(), getHeight(),
          getElevation(), isMovable(), 1, 0, new Sash [0], getColor(), getModelRotation(), isBackFaceShown(),
          getIconYaw(), isProportional());
    } else {
      newPiece = new CatalogPieceOfFurniture(getMetadata(), getRol(), getName(), getIcon(), getModel(), getAmount(), getWidth(), getDepth(), getHeight(),
          getElevation(), isMovable(), getColor(), getModelRotation(), isBackFaceShown(), getIconYaw(),
          isProportional());
    }
  ...
  /**
   * Controls new piece added to home. Once added the furniture will be selected
   * in view and undo support will receive a new undoable edit.
  ...
  private static class PieceOfFurnitureImportationUndoableEdit extends AbstractUndoableEdit {
    ...
    private PieceOfFurnitureImportationUndoableEdit(Home home, UserPreferences preferences,
                                                    List<Selectable> oldSelection, HomePieceOfFurniture piece,
                                                    int pieceIndex) {
      this.home = home;
      this.preferences = preferences;
    ...
    public String getPresentationName() {
      return this.preferences.getLocalizedString(ImportedFurnitureWizardController.class, "undoImportFurnitureName");
    }
  }
  ...
  /**
   * Returns the metadata of the imported piece.
   */
  ...
  /**
   * Sets the metadata of the imported piece.
   */
  ...
  /**
   * Returns the rol of the imported piece.
   */
  ...
  /**
   * Sets the rol of the imported piece.
   */
  ...
  public boolean isPieceOfFurnitureNameValid() {
    ...
    CatalogPieceOfFurniture temporaryPiece = new CatalogPieceOfFurniture(null, null, this.name, null, null, 0, 0, 0, 0, 0, false,
        null, null, false, 0, false);
    if (this.piece != null
        && this.category == this.piece.getCategory()
        // Check piece names are equal with binary search to keep locale
        // dependence
        && Collections.binarySearch(this.category.getFurniture(), this.piece) == Collections.binarySearch(
            this.category.getFurniture(), temporaryPiece)) {
  ...
  /**
   * Step state superclass. All step state share the same step view, that will
   * display a different component depending on their class name.
   */
  ...
  private class FurnitureModelStepState extends ImportedFurnitureWizardStepState {
    public FurnitureModelStepState() {
      ImportedFurnitureWizardController.this.addPropertyChangeListener(Property.MODEL, new PropertyChangeListener() {
  ...
  private class FurnitureAttributesStepState extends ImportedFurnitureWizardStepState {
    PropertyChangeListener widthChangeListener           = new PropertyChangeListener() {
                                                           public void propertyChange(PropertyChangeEvent ev) {
                                                             if (isProportional()) {
                                                               ImportedFurnitureWizardController.this
                                                                   .removePropertyChangeListener(Property.DEPTH,
                                                                       depthChangeListener);
                                                               ImportedFurnitureWizardController.this
                                                                   .removePropertyChangeListener(Property.HEIGHT,
                                                               ...
                                                               // depth and
                                                               // height
                                                               float ratio = (Float) ev.getNewValue()
                                                                             / (Float) ev.getOldValue();
                                                               setDepth(getDepth() * ratio);
                                                               setHeight(getHeight() * ratio);

                                                               ImportedFurnitureWizardController.this
                                                                   .addPropertyChangeListener(Property.DEPTH,
                                                                       depthChangeListener);
                                                               ImportedFurnitureWizardController.this
                                                                   .addPropertyChangeListener(Property.HEIGHT,
                                                                       heightChangeListener);
                                                             }
                                                           }
                                                         };
    PropertyChangeListener depthChangeListener           = new PropertyChangeListener() {
                                                           public void propertyChange(PropertyChangeEvent ev) {
                                                             if (isProportional()) {
                                                               ImportedFurnitureWizardController.this
                                                                   .removePropertyChangeListener(Property.WIDTH,
                                                                       widthChangeListener);
                                                               ImportedFurnitureWizardController.this
                                                                   .removePropertyChangeListener(Property.HEIGHT,
                                                                       heightChangeListener);
                                                               ...
                                                               ImportedFurnitureWizardController.this
                                                                   .addPropertyChangeListener(Property.WIDTH,
                                                                       widthChangeListener);
                                                               ImportedFurnitureWizardController.this
                                                                   .addPropertyChangeListener(Property.HEIGHT,
                                                                       heightChangeListener);
