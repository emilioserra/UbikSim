...
import ubik3d.viewcontroller.PlanController.Mode;
...
public class HomeController implements Controller {
  ...
  private void addHomeItemsListener() {
    ...
    this.home.addFurnitureListener(homeItemsListener);
    this.home.addWallsListener(homeItemsListener);
    this.home.addRoomsListener(homeItemsListener);
    this.home.addDimensionLinesListener(homeItemsListener);
    this.home.addLabelsListener(homeItemsListener);
