...
public class Room implements Serializable, Selectable {
   ...
   */
  public enum Property {NAME, TYPE, NAME_X_OFFSET, NAME_Y_OFFSET, NAME_STYLE,
  ...
  public void setType(String type) {
    if (type != this.type
     ...
     String oldName = this.type;
     this.type = type;
     this.propertyChangeSupport.firePropertyChange(Property.TYPE.name(), oldName, type);
   }
 }
