...
public class HomePieceOfFurniture implements PieceOfFurniture, Serializable, Selectable {
   ...
   * <code>PropertyChangeListener</code>s added to a piece of furniture will be
   * notified under a property name equal to the string value of one these
   * properties.
   */
  public enum Property {
    METADATA, ROL, NAME, NAME_VISIBLE, AMOUNT, NAME_X_OFFSET, NAME_Y_OFFSET, NAME_STYLE, DESCRIPTION, WIDTH, DEPTH, HEIGHT, COLOR, TEXTURE, SHININESS, VISIBLE, X, Y, ELEVATION, ANGLE, MODEL_MIRRORED, MOVABLE
  };
  ...
  public enum SortableProperty {
    CATALOG_ID, NAME, WIDTH, DEPTH, HEIGHT, MOVABLE, DOOR_OR_WINDOW, COLOR, TEXTURE, VISIBLE, X, Y, ELEVATION, ANGLE, PRICE, VALUE_ADDED_TAX, VALUE_ADDED_TAX_PERCENTAGE, PRICE_VALUE_ADDED_TAX_INCLUDED
  };

  private static final Map<SortableProperty, Comparator<HomePieceOfFurniture>> SORTABLE_PROPERTY_COMPARATORS;
  private static final float [][]                                              IDENTITY = new float [] [] { {1, 0, 0},
      {0, 1, 0}, {0, 0, 1}                                                              };
  ...
  /**
   * Initializes new piece fields to their default values and reads piece from
  ...
  /**
   * Sets the metadata of this piece of furniture. Once this piece is updated,
   * listeners added to this piece will receive a change notification.
   */
  public void setMetadata(String metadata) {
    if (metadata != this.metadata || (metadata != null && !metadata.equals(this.metadata))) {
  ...
  /**
   * Sets the rol of this piece of furniture. Once this piece is updated,
   * listeners added to this piece will receive a change notification.
   */
  public void setRol(String rol) {
    if (rol != this.rol || (rol != null && !rol.equals(this.rol))) {
  ...
  /**
   * Returns the catalog ID of this piece of furniture or <code>null</code> if
   * it doesn't exist.
   */
   ...
   * As this method existed before {@linkplain HomeDoorOrWindow
   * HomeDoorOrWindow} class, you shouldn't rely on the value returned by this
   * method to guess if a piece is an instance of <code>DoorOrWindow</code>
   * class.
   */
   ...
   * @return the color of the piece as RGB code or <code>null</code> if piece
   *         color is unchanged.
   */
  ...
  /**
   * Sets the color of this piece of furniture or <code>null</code> if piece
   * color is unchanged. Once this piece is updated, listeners added to this
   * piece will receive a change notification.
   ...
   * @return the texture of the piece or <code>null</code> if piece texture is
   *         unchanged.
   * @since 2.3
   */
  ...
  /**
   * Sets the texture of this piece of furniture or <code>null</code> if piece
   * texture is unchanged. Once this piece is updated, listeners added to this
   * piece will receive a change notification.
   * @throws IllegalStateException if this piece of furniture isn't texturable
   * @since 2.3
   */
   ...
   * @return a value between 0 (matt) and 1 (very shiny) or <code>null</code> if
   *         piece shininess is unchanged.
   * @since 3.0
   */
  ...
  /**
   * Sets the shininess of this piece of furniture or <code>null</code> if piece
   * shininess is unchanged. Once this piece is updated, listeners added to this
   * piece will receive a change notification.
   * @throws IllegalStateException if this piece of furniture isn't texturable
   * @since 3.0
   */
  ...
  /**
   * Returns the Value Added Tax applied to the price of this piece of
   * furniture.
   */
  ...
  /**
   * Sets the angle of this piece. Once this piece is updated, listeners added
   ...
   * this piece is updated, listeners added to this piece will receive a change
   * notification.
   * @throws IllegalStateException if this piece of furniture isn't resizable
   */
  public void setModelMirrored(boolean modelMirrored) {
    if (isResizable()) {
      if (modelMirrored != this.modelMirrored) {
        ...
        this.propertyChangeSupport.firePropertyChange(Property.MODEL_MIRRORED.name(), !modelMirrored, modelMirrored);
      }
    } else {
      throw new IllegalStateException("Piece isn't resizable");
    }
  ...
  /**
   * Returns <code>true</code> if this piece contains the point at (
  ...
  /**
   * Returns <code>true</code> if the top left point of this piece is the point
   * at (<code>x</code>, <code>y</code>) with a given <code>margin</code>, and
   * if that point is closer to top left point than to top right and bottom left
   * points.
   */
  ...
  /**
   * Returns <code>true</code> if the top right point of this piece is the point
   * at (<code>x</code>, <code>y</code>) with a given <code>margin</code>, and
   * if that point is closer to top right point than to top left and bottom
   * right points.
   */
   ...
   * point at (<code>x</code>, <code>y</code>) with a given <code>margin</code>,
   * and if that point is closer to bottom left point than to top left and
   * bottom right points.
   */
   ...
   * point at (<code>x</code>, <code>y</code>) with a given <code>margin</code>,
   * and if that point is closer to top left point than to top right and bottom
   * left points.
   */
   ...
   * name of this piece is equal to the point at (<code>x</code>, <code>y</code>
  ...
  private Shape getShape() {
    if (this.shapeCache == null) {
      ...
      Rectangle2D pieceRectangle = new Rectangle2D.Float(getX() - getWidth() / 2, getY() - getDepth() / 2, getWidth(),
          getDepth());
